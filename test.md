...
mindmap
    ...
    ("OJALÁ")
        {{"🔥 Ojalá + subjuntivo"}}
    ("VERBOS COMO GUSTAR (GUSTAR, ENCANTAR) + VERBOS CON ESTRUCTURA (MOLESTAR, IRRITA, INTERESAR, IMPORTAR)")
        ["Misma persona en Verbo 1 y Verbo 2"]
        {{"🔥 Diferente persona en Verbo 1 y Verbo 2"}}
    ("VERBOS de RECOMENDACIÓN: RECOMENDAR, ACONSEJAR, PROHIBIR, Te recomiendo, Te aconsejo")
        ["TIENE EL MISMO SIGNIFICADO EN SUBJUNTIVO"]
        {{"🔥 que + subjuntivo"}}
    ("VERBOS DE POSIBILIDAD: Es posible que, Es probable que")
        ["Misma persona en Verbo 1 y Verbo 2"]
        {{"🔥 Diferente persona en Verbo 1 y Verbo 2"}}
    ("ORACIONES DE RELATIVO con que, O preposición + el que, la que, los que, las que; Preposición + quien / quienes; Donde (lugar)")
    ...
    ("CUANDO + situación en el futuro, Cuando + presente de subjuntivo")
        ["Situación habitual"]
        {{"🔥 CUANDO + situación en el futuro: Cuando + presente de subjuntivo (en la Frase 1): Presente, Futuro con IR + A + Infinitivo, Futuro, Imperativo"}}
